...
public class KeyLogging_re_18_2_4 {
    public static String solution(int[] keyLog) {
        ...
        while(cmdIdx != keyLog.length){
            ...
            if(cur == BACK_SPACE){
                if(curSor == 0){ //커서가 이면 아무 작업도 하지 않음
                    cmdIdx++;
                    continue;
                }
    ...
    public static void inputDate(StringBuffer sb, char data, int curSor, boolean isInsert){
        if(isInsert == false){
