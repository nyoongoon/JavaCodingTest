...
public class week2_4_ans {
    public static void main(String[] args) {
        ...
        times = new int[]{3, 2, 0, 0, 2, 3, 0, 0, 2, 2, 5};
        System.out.println(solution(5, 5, times)); //3
    }
    ...
    public static int solution(int delay, int capacity, int[] times) {
        ...
        for(int time : times){ // times 가 들어올때마다 result++ 거나 curSize++가 생김
            currentTime += time;
            int maxSent = currentTime / delay;
            curSize = Math.max(0, curSize - maxSent); // 처리되서 빠져나감.
            ...
            currentTime = currentTime % delay; //delay단위로 끊기.
        }
